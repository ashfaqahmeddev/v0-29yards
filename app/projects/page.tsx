...
export const metadata = {
  title: "Our Projects | Build Master Construction",
  description:
    "Explore Build Master's portfolio of completed construction projects across residential, commercial, and industrial sectors.",
}
            ...
            <Tabs defaultValue="all" className="mb-8 md:mb-12">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  {projects.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-12">
                      <p className="text-gray-500 text-lg">New projects coming soon...</p>
                    </div>
                  )}
                </div>
              </TabsContent>
              ...
              <TabsContent value="residential" className="mt-6 md:mt-8">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  {projects.filter((project) => project.category === "Residential").length === 0 && (
                    <div className="col-span-full text-center py-12">
                      <p className="text-gray-500 text-lg">Residential projects coming soon...</p>
                    </div>
                  )}
                </div>
              </TabsContent>
              ...
              <TabsContent value="commercial" className="mt-6 md:mt-8">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  {projects.filter((project) => project.category === "Commercial").length === 0 && (
                    <div className="col-span-full text-center py-12">
                      <p className="text-gray-500 text-lg">Commercial projects coming soon...</p>
                    </div>
                  )}
                </div>
              </TabsContent>
              ...
              <TabsContent value="renovation" className="mt-6 md:mt-8">
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  ...
                  {projects.filter((project) => project.category === "Renovation").length === 0 && (
                    <div className="col-span-full text-center py-12">
                      <p className="text-gray-500 text-lg">Renovation projects coming soon...</p>
                    </div>
                  )}
                </div>
              </TabsContent>
            ...
            <div>
              ...
              <div className="space-y-4 md:space-y-6">
                <div className="flex items-start">
                  <div className="bg-slate-100 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                    <span className="text-slate-700 font-bold text-sm md:text-base">1</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-slate-100 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                    <span className="text-slate-700 font-bold text-sm md:text-base">2</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-slate-100 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                    <span className="text-slate-700 font-bold text-sm md:text-base">3</span>
                  </div>
                  <div>
                ...
                <div className="flex items-start">
                  <div className="bg-slate-100 w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center mr-3 md:mr-4 flex-shrink-0">
                    <span className="text-slate-700 font-bold text-sm md:text-base">4</span>
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <Link href="/contact">
              <Button
                size="lg"
                className="bg-slate-500 hover:bg-slate-600 text-black font-semibold px-6 md:px-8 w-full sm:w-auto"
              >
                Get in Touch
    ...
    <Card className="overflow-hidden group h-full">
      <div className="relative h-48 sm:h-56 md:h-64 w-full">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
          <div className="p-4 md:p-6 w-full">
            ...
            <p className="text-slate-300 mb-4">{project.category}</p>
      ...
      <CardFooter className="p-4 md:p-6 pt-0">
        <Link href={`/projects/${project.id}`}>
          <Button
            variant="outline"
            className="border-amber-500 text-slate-500 hover:bg-slate-500 hover:text-white text-sm sm:text-base bg-transparent"
          >
            View Details
            <ArrowRight className="ml-2 h-4 w-4" />
          </Button>
